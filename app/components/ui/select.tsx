  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-input bg-background px-3.5 py-2 text-sm shadow-sm " +
        ...
        "hover:border-input/60 hover:shadow " +
        "focus:outline-none focus:border-primary focus:shadow-[0_0_0_4px_hsl(var(--primary)/0.12)] " +
        "data-[state=open]:border-primary data-[state=open]:shadow-[0_0_0_4px_hsl(var(--primary)/0.12)] " +
